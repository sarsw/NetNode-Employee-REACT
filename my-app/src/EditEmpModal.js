                ...
                >
                    ...
                    <Modal.Body>
                        <Row>
                            <Col sm={6}>
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    <Form.Group controlId="DateOfJoining">
                                        ...
                                        <Form.Control type="date" name="DateOfJoining" required placeholder="Joined Date" defaultValue={this.props.doj}/>
                                    </Form.Group>                                    
                                    <Form.Group>
                            ...
                            <Col sm={6}>
                                <Image width="200px" height="200px" src={process.env.REACT_APP_PICSPATH+this.props.photofilename}/>
