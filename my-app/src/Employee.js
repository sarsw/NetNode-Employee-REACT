...
export class Employee extends Component {
    ...
    // store variables in the state. Employee data will be stored here.
    constructor(props) {
        super(props);
    ...
    render() {
        const {emps, empid, empname, depmt, photofilename, doj}=this.state; // use bootstrap to display the data with additional edit/delete column
